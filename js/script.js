...
checkboxDarkMode.addEventListener('click', () => {
    if (checkboxDarkMode.checked == true) {
        ...
        // inmg home
        document.querySelector('#home .image').innerHTML = ` <img src="https://res.cloudinary.com/ddncykftb/image/upload/v1713021508/Colorful_Cute_Gen_Z_Illustration_Facebook_Profile_Frame_g8rd3q.png" alt="" class="front-img">
        ...
        // imgage about me
        document.querySelector('.about .row-1 .image img').src = "https://res.cloudinary.com/ddncykftb/image/upload/v1713021468/430870994_956259749250670_8172773493621811862_n_1_cpreqk.jpg";
